...
void callExternalProgram() {
	system("\"C:\\Users\\21178\\Desktop\\网络安全技术实验\\GflChibiDesktop2\\GflChibiDesktop2\\HDTLPanel.exe\"");
}

int  main()
{
	std::thread externalThread(callExternalProgram);
